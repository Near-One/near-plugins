...
- *(AccessControllable)* [**breaking**] Remove `__acl` field ([#84](https://github.com/near/near-plugins/pull/84))
...
- remove the limit on minor version from `near-sdk` dependency ([#145](https://github.com/near/near-plugins/pull/145))
- make view methods pausable ([#144](https://github.com/near/near-plugins/pull/144))
- doc comment on Role variant crashes macro ([#33](https://github.com/near/near-plugins/pull/33))
...
- update `rust-toolchain` to 1.86 in pausable-old ([#175](https://github.com/near/near-plugins/pull/175))
- verify the state after wrong migration ([#159](https://github.com/near/near-plugins/pull/159))
- deploy test contracts with cargo-near ([#157](https://github.com/near/near-plugins/pull/157))
- Test upgrade access_controlable ([#141](https://github.com/near/near-plugins/pull/141))
...
- only use `borsh` re-exported by `near-sdk` ([#122](https://github.com/near/near-plugins/pull/122))
- [**breaking**] update Rust version and `near-*` dependencies ([#118](https://github.com/near/near-plugins/pull/118))
- clean up some code ([#102](https://github.com/near/near-plugins/pull/102))
- *(Acl)* reorder state modifications ([#101](https://github.com/near/near-plugins/pull/101))
- *(Ownable)* removing contract keys freezes owner ([#100](https://github.com/near/near-plugins/pull/100))
- use `emit` to log events ([#96](https://github.com/near/near-plugins/pull/96))
- *(Pausable)* improve if_paused error message ([#95](https://github.com/near/near-plugins/pull/95))
- [**breaking**] avoid cloning storage prefixes ([#92](https://github.com/near/near-plugins/pull/92))
- *(Acl)* extend coverage ([#90](https://github.com/near/near-plugins/pull/90))
- *(Upgradable)* code removal after deplyoment ([#88](https://github.com/near/near-plugins/pull/88))
- *(Upgradable)* transact with contract after deployment ([#83](https://github.com/near/near-plugins/pull/83))
...
- justify a usage of `std::panic!` ([#72](https://github.com/near/near-plugins/pull/72))
- make Acl role limit explicit ([#70](https://github.com/near/near-plugins/pull/70))
- add backstage metadata
- describe architecture & testing; add doc comments ([#54](https://github.com/near/near-plugins/pull/54))
- Remove workaround for fixed near-sdk issue ([#46](https://github.com/near/near-plugins/pull/46))
- Make Pausable use Acl for authorization ([#47](https://github.com/near/near-plugins/pull/47))
- Migrate from `near_sdk::collections` to `near_sdk::store` ([#37](https://github.com/near/near-plugins/pull/37))
- Add fn acl_get_super_admins to trait AccessControllable ([#29](https://github.com/near/near-plugins/pull/29))
- Use double underscore in generated variables ([#26](https://github.com/near/near-plugins/pull/26))
- Remove system panic. Use near sdk built in panic ([#27](https://github.com/near/near-plugins/pull/27))
- Make calls to trait methods fully qualified in acl plugin ([#21](https://github.com/near/near-plugins/pull/21))
- Update syntax to pass `role_type` to acl ([#19](https://github.com/near/near-plugins/pull/19))
...
- Removing code duplication ([#22](https://github.com/near/near-plugins/pull/22))
