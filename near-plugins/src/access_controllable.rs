...
pub trait AccessControllable {
    ...
    /// }
    /// ```
    fn acl_init_super_admin(account_id: AccountId) -> bool;
    ...
    /// }
    /// ```
    fn acl_add_super_admin(account_id: AccountId) -> Option<bool>;
    ...
    /// grantee of any role.
    fn acl_is_super_admin(account_id: AccountId) -> bool;
    ...
    /// }
    /// ```
    fn acl_revoke_super_admin(account_id: AccountId) -> Option<bool>;
    ...
    /// }
    /// ```
    fn acl_transfer_super_admin(account_id: AccountId) -> Option<bool>;
    ...
    /// }
    /// ```
    fn acl_add_admin(role: String, account_id: AccountId) -> Option<bool>;
    ...
    fn acl_is_admin(role: String, account_id: AccountId) -> bool;
    ...
    /// }
    /// ```
    fn acl_revoke_admin(role: String, account_id: AccountId) -> Option<bool>;
    ...
    /// }
    /// ```
    fn acl_grant_role(role: String, account_id: AccountId) -> Option<bool>;
    ...
    fn acl_has_role(role: String, account_id: AccountId) -> bool;
    ...
    /// }
    /// ```
    fn acl_revoke_role(role: String, account_id: AccountId) -> Option<bool>;
    ...
    fn acl_get_permissioned_accounts() -> PermissionedAccounts;
}
