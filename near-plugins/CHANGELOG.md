...
## [0.6.0](https://github.com/Near-One/near-plugins/releases/tag/near-plugins-v0.6.0) - 2026-04-03
...
- ABI generation ([#146](https://github.com/Near-One/near-plugins/pull/146))
...
- add a change log ([#103](https://github.com/Near-One/near-plugins/pull/103))
- *(Acl)* add module-level docs ([#99](https://github.com/Near-One/near-plugins/pull/99))
- *(Upgradable)* remove confusing statement ([#97](https://github.com/Near-One/near-plugins/pull/97))
...
- deduplicate `Upgradable` docs and examples ([#80](https://github.com/Near-One/near-plugins/pull/80))
- add integration tests for `Upgradable` ([#79](https://github.com/Near-One/near-plugins/pull/79))
- Add support for the delayed upgrade ([#44](https://github.com/Near-One/near-plugins/pull/44))
- add notes on upgrading vulnerable code ([#71](https://github.com/Near-One/near-plugins/pull/71))
- extend `acl_revoke_admin` docs ([#68](https://github.com/Near-One/near-plugins/pull/68))
- add backstage metadata
- add integration tests for `FullAccessKeyFallback` ([#66](https://github.com/Near-One/near-plugins/pull/66))
- fix clippy errors in `near-plugins/tests` ([#63](https://github.com/Near-One/near-plugins/pull/63))
- deduplicate `Ownable` docs and examples ([#62](https://github.com/Near-One/near-plugins/pull/62))
- mention `Ownable::owner_is` fails in view calls ([#60](https://github.com/Near-One/near-plugins/pull/60))
- add integration tests for `Ownable` plugin ([#59](https://github.com/Near-One/near-plugins/pull/59))
- Acl test contract names of roles and methods ([#57](https://github.com/Near-One/near-plugins/pull/57))
- deduplicate `AccessControllable` docs and examples ([#55](https://github.com/Near-One/near-plugins/pull/55))
- describe architecture & testing; add doc comments ([#54](https://github.com/Near-One/near-plugins/pull/54))
- deduplicate `Pausable` docs and examples ([#53](https://github.com/Near-One/near-plugins/pull/53))
- add integration tests for `Pausable` plugins ([#51](https://github.com/Near-One/near-plugins/pull/51))
- Pausable `except` works when `ALL` is paused ([#49](https://github.com/Near-One/near-plugins/pull/49))
- Add details of Pausable integration with Acl ([#50](https://github.com/Near-One/near-plugins/pull/50))
- Make Pausable use Acl for authorization ([#47](https://github.com/Near-One/near-plugins/pull/47))
- Add examples on plugins usage ([#34](https://github.com/Near-One/near-plugins/pull/34))
